...
export default function SignupPage() {
    ...
    const validateForm = () => {
        ...
        const isvalidWeb = isShopExist('website')
        // if (formData.website && !formData.checkEmail) {
        ...
        const cal = passValid(formData.password)
                        ...
                        <form className='mt-2 p-3' >
                            ...
                            <Row className=' px-0 px-md-5 mt-3 '>
                                ...
                                <Col xs="12" className='mt-2'>
                                    ...
                                    <input type="text" className="form-control form-control  fs-5 text-dark rounded-1" onChange={handleInputChange} onBlur={(e) => { isShopExist('website') }} placeholder="Store URL" name="website" style={{ marginTop: "4px" }} />
                                    <span className="error text-danger ">{formErrors.website}</span>

                                </Col>
                                <Col xs="12" className='mt-2'>
                                    <label className="fs-4 main-heading">Email Address  </label>
                                    <input type="text" className="form-control form-control  fs-5 text-dark rounded-1" onChange={handleInputChange} onBlur={(e) => { isEmailExist('email') }} placeholder="Email" name="email" style={{ marginTop: "4px" }} />
