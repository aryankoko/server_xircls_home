                        ...
                        <Col xs="11" md="10" xl="8"  >
                            ...
                            <div className=' mt180 px-0 px-lg-5 '>
                                <div className='d-flex gap-5  justify-content-start  align-items-center '>
                                    <img src="https://api.xircls.com/static/images/website-slide/sn1.jpg" alt="" width={140} style={{ minWidth: '140px' }} />
                                    <div>
                                ...
                                <div className='d-flex flex-row-reverse  gap-5  justify-content-end  align-items-center mt170'>
                                    <img src="https://api.xircls.com/static/images/website-slide/sn2.jpg" alt="" width={140} style={{ minWidth: '140px' }} />
                                    <div>
                                ...
                                <div className='d-flex gap-5  justify-content-start  align-items-center mt170'>
                                    <img src="https://api.xircls.com/static/images/website-slide/sn3.jpg" alt="" width={140} style={{ minWidth: '140px' }} />
                                    <div>
                                        <h1 className='main-heading fw-bolder  display-4'>Real-time match making for businesses.</h1>
                            ...
                            <div className='mt180 '>
                                ...
                                <Row className='mt-4 justify-content-center '>
                                    <Col lg="4" className='text-center text-lg-end '>
                                        <img src="https://api.xircls.com/static/images/website-slide/sn4.jpg" alt="" width={200} />
                                    </Col>
                                    <Col lg="8" className=''>
                                        <ul>
